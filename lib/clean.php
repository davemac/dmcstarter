...
if ( ! function_exists( 'dmcstarter_startup ' ) ) {
...
WP_HEAD Cleanup
**********************/
if ( ! function_exists( 'dmcstarter_head_cleanup ' ) ) {
...
// remove WP version from scripts
if ( ! function_exists( 'dmcstarter_remove_wp_ver_css_js ' ) ) {
...
if ( ! function_exists( 'dmcstarter_cleaner_caption ' ) ) {
...
if ( ! function_exists( 'dmcstarter_image_editor ' ) ) {
