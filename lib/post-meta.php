...
if ( ! function_exists( 'dmc_display_post_type_label' ) ) {
...
if ( ! function_exists( 'dmc_display_post_tax_terms' ) ) {
...
if ( ! function_exists( 'dmc_get_post_tax_single_topic' ) ) {
...
if ( ! function_exists( 'dmc_tax_terms_filter' ) ) {
...
if ( ! function_exists( 'dmcstarter_entry_meta' ) ) {
...
if ( ! function_exists( 'dmc_display_featured_img_bg' ) ) {
...
if ( ! function_exists( 'dmc_display_acf_img_bg' ) ) {
...
if ( ! function_exists( 'dmc_display_acf_random_img_bg' ) ) {
...
if ( ! function_exists( 'dmc_display_cal_date' ) ) {
...
if ( ! function_exists( 'dmc_user_profile_box' ) ) {
...
if ( ! function_exists( 'dmc_user_profile_box_small' ) ) {
...
if ( ! function_exists( 'dmc_show_staff_socials' ) ) {
...
if ( ! function_exists( 'dmc_display_nice_course_dates' ) ) {
